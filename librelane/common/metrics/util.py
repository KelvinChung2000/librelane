...
from librelane.common.misc import Filter
...
def parse_metric_modifiers(metric_name: str) -> tuple[str, Mapping[str, str]]:
    ...
    ----------
    metric_name : str
        The name of the metric as generated by a utility.

    Returns
    -------
    tuple[str, Mapping[str, str]]
        A tuple of the base part as a string, then the modifiers as
        a key-value mapping.
    """
...
def aggregate_metrics(
    ...
    ----------
    input : Mapping[str, Any]
        A mapping of strings to values of metrics.
    aggregator_by_metric : Mapping[str, MetricAggregator | Metric] | None
        A mapping of metric names to either:
...
class MetricDiff(object):
    ...
    Parameters
    ----------
    differences : Iterable[MetricComparisonResult]
        The metric comparison results.
    """
    ...
    class MetricStatistics:
        ...
        ----------
        better : int
            The number of datapoints that represent a positive change.
        worse : int
            The number of datapoints that represent a negative change.
        critical : int
            The number of changes for critical metrics.
        unchanged : int
    ...
    def render_md(
        ...
        sort_by : Iterable[str] | None
            A list of tuples corresponding to modifiers to sort
            metrics ascendingly by.
        table_verbosity : TableVerbosity
            The verbosity of the table: whether to include everything, just changes, only bad changes or only critical changes. Or just nothing.
    ...
    def stats(self) -> MetricStatistics:
        ...
        -------
        MetricStatistics
            A :class:`MetricStatistics` object based on this aggregate.
        """
    ...
    def from_metrics(
        ...
        ----------
        gold : dict
            The "gold-standard" metrics to compare against
        new : dict
            The metrics being evaluated
        filter : Filter
            A :class:`Filter` for the names of the metrics to include
