...
class DRC:
    ...
    def from_magic(
        ...
        ----------
        report : io.TextIOWrapper
            A **text** input stream containing the report in question.
            You can pass the result of ``open("drc.rpt")``, for example.

        Returns
        -------
        tuple[DRC, int]
            A tuple of the DRC object and an int representing the number
            of DRC violations.
        """
    ...
    def to_klayout_xml(self, out: io.BufferedIOBase):
        ...
        out : io.BufferedIOBase
            A **binary** output stream to the target XML file.
