...
# Innovus.DetailedPlacement.run() (inherited from VendorTclStep) raises
...
#   - Run detailed placement (legalization) and write DEF, netlist and SDC
#     views to the paths in SAVE_DEF, SAVE_NL and SAVE_SDC, which
