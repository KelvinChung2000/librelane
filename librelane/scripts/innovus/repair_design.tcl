...
#   - Repair design violations found after global placement (buffering,
#     resizing) and write DEF, netlist and SDC views to the paths in
#     SAVE_DEF, SAVE_NL and SAVE_SDC, which prepare_env() sets because
