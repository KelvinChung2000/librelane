...
# Fusion Compiler (fc_shell) -- antenna_repair stage scaffold.
#
# Implements: the 'antenna_repair' stage (librelane/stages/taxonomy.py), for the
# FC.AntennaRepair step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.AntennaRepair.run() (inherited from
