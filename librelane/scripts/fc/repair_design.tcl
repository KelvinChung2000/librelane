...
# Fusion Compiler (fc_shell) -- post_gpl_repair stage scaffold.
#
# Implements: the 'post_gpl_repair' stage (librelane/stages/taxonomy.py), for the
# FC.PostGPLRepair step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.PostGPLRepair.run() (inherited from
