...
# Fusion Compiler (fc_shell) -- power_grid stage scaffold.
#
# Implements: the 'power_grid' stage (librelane/stages/taxonomy.py), for the
# FC.PowerGrid step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.PowerGrid.run() (inherited from
