...
# Fusion Compiler (fc_shell) -- post_cts_opt stage scaffold.
#
# Implements: the 'post_cts_opt' stage (librelane/stages/taxonomy.py), for the
# FC.PostCTSOpt step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.PostCTSOpt.run() (inherited from
