...
# Fusion Compiler (fc_shell) -- fill_insertion stage scaffold.
#
# Implements: the 'fill_insertion' stage (librelane/stages/taxonomy.py), for the
# FC.FillInsertion step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.FillInsertion.run() (inherited from
