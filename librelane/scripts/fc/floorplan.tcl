...
# Fusion Compiler (fc_shell) -- floorplan stage scaffold.
#
# Implements: the 'floorplan' stage (librelane/stages/taxonomy.py), for the
# FC.Floorplan step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.Floorplan.run() (inherited from
