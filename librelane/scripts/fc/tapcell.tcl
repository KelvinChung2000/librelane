...
# Fusion Compiler (fc_shell) -- tapcell_insertion stage scaffold.
#
# Implements: the 'tapcell_insertion' stage (librelane/stages/taxonomy.py), for the
# FC.TapcellInsertion step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.TapcellInsertion.run() (inherited from
