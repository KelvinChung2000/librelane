...
# Fusion Compiler (fc_shell) -- global_routing stage scaffold.
#
# Implements: the 'global_routing' stage (librelane/stages/taxonomy.py), for the
# FC.GlobalRouting step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.GlobalRouting.run() (inherited from
