...
# Fusion Compiler (fc_shell) -- detailed_routing stage scaffold.
#
# Implements: the 'detailed_routing' stage (librelane/stages/taxonomy.py), for the
# FC.DetailedRouting step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.DetailedRouting.run() (inherited from
