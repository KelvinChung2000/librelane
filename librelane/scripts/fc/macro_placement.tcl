...
# Fusion Compiler (fc_shell) -- macro_placement stage scaffold.
#
# Implements: the 'macro_placement' stage (librelane/stages/taxonomy.py), for the
# FC.MacroPlacement step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.MacroPlacement.run() (inherited from
