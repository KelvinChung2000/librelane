...
# Fusion Compiler (fc_shell) -- io_placement stage scaffold.
#
# Implements: the 'io_placement' stage (librelane/stages/taxonomy.py), for the
# FC.IOPlacement step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.IOPlacement.run() (inherited from
