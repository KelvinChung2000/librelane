...
# Fusion Compiler (fc_shell) -- global_placement stage scaffold.
#
# Implements: the 'global_placement' stage (librelane/stages/taxonomy.py), for the
# FC.GlobalPlacement step (librelane/steps/fc.py).
#
...
# tested, and none is guessed here. FC.GlobalPlacement.run() (inherited from
