...
# IC Compiler II (icc2_shell) -- power_grid stage scaffold.
#
# Implements: the 'power_grid' stage (librelane/stages/taxonomy.py), for the
# ICC2.PowerGrid step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/pdn.tcl, which
...
# tested, and none is guessed here. ICC2.PowerGrid.run() (inherited from
