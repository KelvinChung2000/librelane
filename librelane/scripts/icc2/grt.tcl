...
# IC Compiler II (icc2_shell) -- global_routing stage scaffold.
#
# Implements: the 'global_routing' stage (librelane/stages/taxonomy.py), for the
# ICC2.GlobalRouting step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/grt.tcl, which
...
# tested, and none is guessed here. ICC2.GlobalRouting.run() (inherited from
