...
# IC Compiler II (icc2_shell) -- detailed_placement stage scaffold.
#
# Implements: the 'detailed_placement' stage (librelane/stages/taxonomy.py), for the
# ICC2.DetailedPlacement step (librelane/steps/icc2.py).
#
...
# tested, and none is guessed here. ICC2.DetailedPlacement.run() (inherited from
