...
# IC Compiler II (icc2_shell) -- detailed_routing stage scaffold.
#
# Implements: the 'detailed_routing' stage (librelane/stages/taxonomy.py), for the
# ICC2.DetailedRouting step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/drt.tcl, which
...
# tested, and none is guessed here. ICC2.DetailedRouting.run() (inherited from
