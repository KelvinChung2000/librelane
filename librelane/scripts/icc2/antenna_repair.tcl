...
# IC Compiler II (icc2_shell) -- antenna_repair stage scaffold.
#
# Implements: the 'antenna_repair' stage (librelane/stages/taxonomy.py), for the
# ICC2.AntennaRepair step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/antenna_repair.tcl, which
...
# tested, and none is guessed here. ICC2.AntennaRepair.run() (inherited from
