...
# IC Compiler II (icc2_shell) -- cts stage scaffold.
#
# Implements: the 'cts' stage (librelane/stages/taxonomy.py), for the
# ICC2.CTS step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/cts.tcl, which
...
# tested, and none is guessed here. ICC2.CTS.run() (inherited from
