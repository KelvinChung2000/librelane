...
# IC Compiler II (icc2_shell) -- post_grt_opt job scaffold.
#
# Implements: the 'post_grt_opt' job (librelane/jobs/taxonomy.py), for the
# ICC2.PostGRTOpt step (librelane/steps/icc2.py).
#
...
# tested, and none is guessed here. ICC2.PostGRTOpt.run() (inherited from
