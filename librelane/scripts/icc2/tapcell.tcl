...
# IC Compiler II (icc2_shell) -- tapcell_insertion stage scaffold.
#
# Implements: the 'tapcell_insertion' stage (librelane/stages/taxonomy.py), for the
# ICC2.TapcellInsertion step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/tapcell.tcl, which
...
# tested, and none is guessed here. ICC2.TapcellInsertion.run() (inherited from
