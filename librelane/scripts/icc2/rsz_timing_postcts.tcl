...
# IC Compiler II (icc2_shell) -- post_cts_opt stage scaffold.
#
# Implements: the 'post_cts_opt' stage (librelane/stages/taxonomy.py), for the
# ICC2.PostCTSOpt step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/rsz_timing_postcts.tcl, which
...
# tested, and none is guessed here. ICC2.PostCTSOpt.run() (inherited from
