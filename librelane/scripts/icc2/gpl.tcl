...
# IC Compiler II (icc2_shell) -- global_placement stage scaffold.
#
# Implements: the 'global_placement' stage (librelane/stages/taxonomy.py), for the
# ICC2.GlobalPlacement step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/gpl.tcl, which
...
# tested, and none is guessed here. ICC2.GlobalPlacement.run() (inherited from
