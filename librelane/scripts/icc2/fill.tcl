...
# IC Compiler II (icc2_shell) -- fill_insertion stage scaffold.
#
# Implements: the 'fill_insertion' stage (librelane/stages/taxonomy.py), for the
# ICC2.FillInsertion step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/fill.tcl, which
...
# tested, and none is guessed here. ICC2.FillInsertion.run() (inherited from
