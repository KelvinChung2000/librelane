...
# IC Compiler II (icc2_shell) -- floorplan stage scaffold.
#
# Implements: the 'floorplan' stage (librelane/stages/taxonomy.py), for the
# ICC2.Floorplan step (librelane/steps/icc2.py).
#
# Filename mirrors librelane/scripts/openroad/floorplan.tcl, which
...
# tested, and none is guessed here. ICC2.Floorplan.run() (inherited from
