...
class ResourcePools:
    ...
    :meth:`librelane.engine.engine.Workflow.run` for the engine-level
    ...
    capacities : Mapping[str, int]
        ...
        integer by the caller -- :meth:`librelane.engine.engine.Workflow._resolve_resource_pools`
    ...
    on_release : Callable[[], None] | None
        ...
        :meth:`~librelane.engine.engine.Workflow.run` installs its own
