...
# librelane.jobs.Job, and test/flows/test_job.py, which tests the resolved
...
#
# test/flows/ deliberately has no __init__.py. Adding one gives both modules
# the bare name test_job and pytest aborts collection with an
# import-file-mismatch error. If you need test/flows to be a package, rename
